...
if __name__ == "__main__":
    ...
    # User inputs
    wf_dir = "/home/gilbert_lab/meager/all_mseed_daily_raw"
    out_dir = "/home/genevieve.savard/seismo-pyscamp/scripts_meager/matrix_profiles"
    ...
    for channel in ["HHZ", "HHX", "HHY"]:
        ...
        if num_days == 1:
            ...
            trace1 = get_stream_1day(station=station, channel=channel, starttime=starttime, endtime=endtime, fs=fs, gain=1, wf_dir=wf_dir)
